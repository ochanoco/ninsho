...
type LineLogin struct {
	...
	Domain           string
	LineLoginSession *line_login.Session
}

func NewLineLogin(r *gin.RouterGroup, provider *line_login.Provider, domain, unauthorized, callback, afterAuth string) (*LineLogin, error) {
